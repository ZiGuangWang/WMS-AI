<template>
  <div class="app-container">
    ...
    <a-card class="action-card" :bordered="false">
      <a-space>
        <a-button type="primary" v-permission="'wms:basic:goods:add'" @click="handleAdd">
          <template #icon><icon-plus /></template>
          新增货品
        </a-button>
        <a-button v-permission="'wms:basic:goods:export'" @click="handleExport">
    ...
    <a-card class="filter-card" :bordered="false">
      <a-form :model="listQuery" layout="inline" @submit="handleFilter">
        ...
        <a-form-item>
          <a-space>
            <a-button type="primary" v-permission="'wms:basic:goods:search'" @click="handleFilter">
              <template #icon><icon-search /></template>
              查询
            </a-button>
            <a-button v-permission="'wms:basic:goods:reset'" @click="resetQuery">
      ...
      >
        <template #columns>
          ...
          <a-table-column title="操作" align="center" :width="180">
            <template #cell="{ record }">
              <a-space>
                <a-button type="text" size="small" v-permission="'wms:basic:goods:edit'" @click="handleEdit(record)">
                  <template #icon><icon-edit /></template>
                  编辑
                </a-button>
                <a-button type="text" status="danger" size="small" v-permission="'wms:basic:goods:delete'" @click="handleDelete(record)">

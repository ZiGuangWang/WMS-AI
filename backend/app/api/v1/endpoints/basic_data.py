...
async def list_goods(
    ...
    _: None = Depends(require_permissions("wms:basic:goods:view")),
):
    query = {}
...
async def create_goods(
    data: GoodsCreate,
    db: AsyncIOMotorDatabase = Depends(get_database),
    _: None = Depends(require_permissions("wms:basic:goods:add")),
):
...
async def update_goods(
    ...
    data: GoodsUpdate,
    db: AsyncIOMotorDatabase = Depends(get_database),
    _: None = Depends(require_permissions("wms:basic:goods:edit")),
):
...
async def delete_goods(
    id: str,
    db: AsyncIOMotorDatabase = Depends(get_database),
    _: None = Depends(require_permissions("wms:basic:goods:delete")),
):
...
async def list_locations(
    ...
    limit: int = Query(20, ge=1, le=1000),
    db: AsyncIOMotorDatabase = Depends(get_database),
    _: None = Depends(require_permissions("wms:basic:location:view")),
):
    query = {}
...
async def create_location(
    data: LocationCreate,
    db: AsyncIOMotorDatabase = Depends(get_database),
    _: None = Depends(require_permissions("wms:basic:location:add")),
):
...
async def update_location(
    ...
    data: LocationUpdate,
    db: AsyncIOMotorDatabase = Depends(get_database),
    _: None = Depends(require_permissions("wms:basic:location:edit")),
):
...
async def delete_location(
    id: str,
    db: AsyncIOMotorDatabase = Depends(get_database),
    _: None = Depends(require_permissions("wms:basic:location:delete")),
):
...
async def list_suppliers(
    ...
    limit: int = Query(20, ge=1, le=1000),
    db: AsyncIOMotorDatabase = Depends(get_database),
    _: None = Depends(require_permissions("wms:basic:supplier:view")),
):
    query = {}
    if name: query["name"] = {"$regex": name, "$options": "i"}
...
async def create_supplier(
    data: SupplierCreate,
    db: AsyncIOMotorDatabase = Depends(get_database),
    _: None = Depends(require_permissions("wms:basic:supplier:add")),
):
...
async def update_supplier(
    ...
    data: SupplierUpdate,
    db: AsyncIOMotorDatabase = Depends(get_database),
    _: None = Depends(require_permissions("wms:basic:supplier:edit")),
):
...
async def delete_supplier(
    id: str,
    db: AsyncIOMotorDatabase = Depends(get_database),
    _: None = Depends(require_permissions("wms:basic:supplier:delete")),
):
